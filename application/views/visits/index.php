...
<div class="container">
        ...
        <div class="row">
            <div class="col-sm-6" >
                ...
                <?php 
                    ...
                    echo form_open('visits/', $attributes); 
                ?>
	...
	<h3>
		<!-- <span class="glyphicon glyphicon-folder-open"></span>&nbsp; visits -->
        <hr />
	</h3>
	<div class="container-fluid message"><?php echo $visits['result_count'] ?> records found. 
		<?php 
			if (isset($filterval)) {
    ...
    <div class="container-fluid">
        ...
        <?php 
            /*
			if (isset($filterval)) { 
				$url = 'visits/filtered_to_excel/'.$filterval[0].'/'.$filterval[1];
			} 
			else if (isset($searchval)) {
				$url = 'visits/results_to_excel/'.$searchval;
			}
			else {
				$url = 'visits/all_to_excel';
			}
            */
            $url = 'visits/all_to_excel';
            if ($visits['result_count'] > 0) echo '<a href="'.$url.'" target="_blank"><i class="fas fa-file-excel"></i> Export to Excel &raquo;</a>';	
